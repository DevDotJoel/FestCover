    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumContents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "AlbumContentIds",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AlbumId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AlbumContentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumContentIds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AlbumContentIds_Albums_AlbumId",
                        column: x => x.AlbumId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d67c7fbd-69bb-4926-acb6-f393143c16b3"), "34a8bd40-92fe-4640-84d5-0da273563aa1", "Administrator", "ADMINISTRATOR" },
                    { new Guid("e67c7fbd-69bb-4926-acb6-f393143c16b3"), "24a8bd40-92fe-4640-84d5-0da273563aa1", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("d67c7fbd-69bb-4926-acb6-f393143c16b3"), new Guid("f69b50aa-de02-423b-abc4-0ba2fb3eb64d") });

            migrationBuilder.CreateIndex(
                name: "IX_AlbumContentIds_AlbumId",
                table: "AlbumContentIds",
                column: "AlbumId");
